...
| --------------------------- | ----------------------------- |
| can read                    | 0                             |
| can translate new segment   | 1                             |
| can edit translations       | 1                             |
| can delete translations     | 1                             |
| can comment                 | 1                             |
| can flag comments           | 1                             |
| can flag translations       | 1                             |
| can flag users              | 1                             |
...
| Name         | Reason                                        |
| ------------ | --------------------------------------------- |
| Initiator    | Translated at least one new segment           |
| Editor       | Edited at lest one segment                    |
| Voter        | 100 Upvotes                                   |
| Guardian     | 100 Rollbacks                                 |
| Helper       | Reached 500 :small_blue_diamond:              |
| Great Helper | Reached 1000 :small_blue_diamond:             |
| Professional | Confirmed professional translator             |
| Contributor  | Work you contributed 20% or more was released |

## (DEPRICATED) Privileges
...
:small_blue_diamond: recom. 10000
